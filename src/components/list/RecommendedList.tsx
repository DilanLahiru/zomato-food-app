  ...
  const renderItem = ({item}: any) => {
    return (
      <ScalePress
        ...
        <CustomText fontSize={10} color={Colors.text}fontFamily='Okra-Medium' numberOfLine={1}>
          {item?.name}
        </CustomText>
        <View style={styles.flexRow}>
          ...
          />
          <CustomText fontSize={9} color={Colors.text}fontFamily='Okra-Medium'>{`${item.time} . ${item?.distance}`}</CustomText>
          </View>
        </View>
      </ScalePress>
    );
